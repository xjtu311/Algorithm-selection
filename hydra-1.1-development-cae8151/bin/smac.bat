...
@rem ##########################################################################
@rem
@rem  smac startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and SMAC_OPTS to pass JVM options to this script.
...
@rem Execute smac
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SMAC_OPTS%  -classpath "%CLASSPATH%" ca.ubc.cs.beta.smac.executors.SMACExecutor %CMD_LINE_ARGS%
...
:fail
rem Set variable SMAC_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%SMAC_EXIT_CONSOLE%" exit 1
exit /b 1
