...
function alltrainperformance=extractModelPredictions_SAT(dataset, preid, seed, mymodel)
if isdeployed
...
[allmodeltest, allmodeldata]=apply_zilla_models_SAT(dataset, preid, seed, mymodel);
for i=1:10
...
outputfilename=sprintf('Train-%s-%s-%d-%d', dataset, mymodel, preid, seed);
